          ...
          <div class="card-content card-border-gray">
            ...
            <div class="row mt-5">
              <div class="col s1 pr-0 circle">
                <a href="#"><img class="responsive-img circle" src="{{asset('app-assets/images/user/12.jpg')}}" alt=""></a>
              </div>
              <div class="col s11">
                <a href="#">
                  ...
                  <div class="col s12">
                    <div class="card card-border z-depth-2">
                      <div class="card-image">
                        <img src="{{asset('app-assets/images/gallery/post-1.png')}}" alt="">
                      </div>
              ...
              <div class="col s11">
                ...
                <div class="row">
                  <div class="col s12">
                    <div class="card card-border z-depth-2">
                      <div class="card-image">
                        <img src="{{asset('app-assets/images/gallery/post-2.png')}}" alt="">
                      </div>
                      <div class="card-content">
                      ...
                      <div class="card-content">
                        <div class="row">
                          <div class="col s2 pr-0 circle">
                            <a href="#"><img class="responsive-img circle" src="{{asset('app-assets/images/user/1.jpg')}}"
                                alt=""></a>
                          </div>
                          <div class="col s10">
                            <a href="#">
    ...
    <div class="col s12 m12 l3 hide-on-med-and-down">
      <div class="row mt-5">
        <div class="col s12">
          ...
          <img class="responsive-img card-border z-depth-2 mt-2" src="{{asset('app-assets/images/gallery/post-3.png')}}"
            alt="">
